        ...
        return (
            <div>
                <div className="p-24 flex flex-1 flex-col items-center justify-center md:flex-row md:items-center">
                    ...
                    <bankwithdrawDialog type='add' onSave={this.handleSave} onRemove={this.handleRemove} row={{SN: '', date: '', transaction: '', dramt: '',details: '', remarks: '',}}/>
                </div>
                        ...
                        {data.map(row => (
                            <TableRow key={row._id}>
                                ...
                                <TableCell align="center">
                                    <bankwithdrawDialog type='edit' onSave={this.handleSave} onRemove={this.handleRemove} row={row}/>
                                </TableCell>
                            </TableRow>
                        ))}
                        {
