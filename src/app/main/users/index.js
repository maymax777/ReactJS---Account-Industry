...
class UserPage extends Component {
  ...
  render() {
    ...
    const { order, orderBy, rolesMap, branchsMap, editRow } = this.state;
                ...
                <TableBody>
                  {data.map(row => (
                    <TableRow key={row.user_Id}>
                      ...
                      <TableCell align="center">{rolesMap[row.roll_Id] && rolesMap[row.roll_Id].rollname}</TableCell>
                      <TableCell align="center">{row.emp_Id}</TableCell>
                      <TableCell align="center">{branchsMap[row.branch_Id] && branchsMap[row.branch_Id].branch_Name}</TableCell>
