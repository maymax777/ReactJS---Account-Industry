...
const rows = [
    { id: 'id', numeric: false, disablePadding: true, label: 'SN' },
    { id: 'customername', numeric: false, disablePadding: false, label: 'Customer Name' },
    { id: 'address', numeric: false, disablePadding: false, label: 'Adress' },
    { id: 'tel', numeric: false, disablePadding: false, label: 'Telephone' },
    { id: 'mob', numeric: false, disablePadding: true, label: 'Mobile' },
    { id: 'netdues', numeric: false, disablePadding: false, label: 'Net' },
];
                ...
                <div className="p-24 flex flex-1 flex-col items-center justify-center md:flex-row md:items-center">
                    {/* <div className="flex flex-1 flex-col items-center justify-center md:flex-row md:items-center md:justify-start">
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Typography className="md:ml-24" variant="h4" color="inherit">Create Bank</Typography>
                        </FuseAnimate>
                    </div> */}
                    ...
                    <CustomerDialog type='add' onSave={this.handleSave} onRemove={this.handleRemove} row={{_id: '', title: '', subtitle: '', description: ''}}/>
                </div>
                        ...
                        {data.map(row => (
                            <TableRow key={row._id}>
                                ...
                                <TableCell align="center">
                                    <CustomerDialog type='edit' onSave={this.handleSave} onRemove={this.handleRemove} row={row}/>
                                </TableCell>
                            </TableRow>
                        ))}
                        {
